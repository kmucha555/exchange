...
@CompileStatic
trait SampleCurrenciesDto {
    LocalDateTime publicationDate = LocalDateTime.of(2020, 4, 11, 14, 3, 1);
    String PLN_UUID = "f7086c16-87bc-4a02-9fe5-146a9f4b6bbe";
    String USD_UUID = "db64b6bc-f5e4-4eb8-9d53-5529f0691896";
    String CZK_UUID = "d1d1570a-f705-41ef-98d9-fb5c1a01c71d";
