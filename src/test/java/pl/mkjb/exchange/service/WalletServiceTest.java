...
//import pl.mkjb.exchange.wallet.domain.WalletService;
...
//        var userWallet = HashSet.of(new UserWalletDto(billingCurrencyRateId, "PLN", BigDecimal.ONE, userWalletCurrencyAmount, BigDecimal.ONE));
...
//
//        //when
//        boolean test = walletService.hasInsufficientFundsToBuyCurrency(currencyRateId, userDetails);
//
//        //then
...
//        var userWallet = HashSet.of(new UserWalletDto(billingCurrencyRateId, "PLN", BigDecimal.ONE, userWalletCurrencyAmount, billingCurrencyPurchasePrice));
//        when(currencyServiceMock.findCurrencyRateByCurrencyRateId(currencyRateId)).thenReturn(currencyRateEntity);
//        when(currencyServiceMock.findBillingCurrencyRate()).thenReturn(billingCurrencyRateEntity);
//        when(transactionRepositoryMock.findUserWallet(userDetails.getUsername())).thenReturn(userWallet);
//
...
//        //given
//        var userWalletCurrencyAmount = BigDecimal.TEN;
//        var userWallet = HashSet.of(new UserWalletDto(currencyRateId, "USD", BigDecimal.ONE, userWalletCurrencyAmount, currencyPurchasePrice));
//        when(currencyServiceMock.findCurrencyRateByCurrencyRateId(currencyRateId)).thenReturn(currencyRateEntity);
//        when(transactionRepositoryMock.findUserWallet(userDetails.getUsername())).thenReturn(userWallet);
//
//        //when
...
//                CurrencyDto.buildCurrencyModel(currencyRateEntityCZK)
//        );
//
//        var currencyRatesModel = CurrencyBundle.of(publicationDate, currencyModels);
//
//        var userWallet = HashSet.of(
//                new UserWalletDto(currencyRateId, "USD", BigDecimal.ONE, userWalletCurrencyAmountUSD, currencyPurchasePrice)
//        );
//
//        when(currencyServiceMock.findBillingCurrencyRate()).thenReturn(billingCurrencyRateEntity);
...
//
//        //when
//        Set<UserWalletDto> test = walletService.getUserWallet(userDetails);
//
//        //then
